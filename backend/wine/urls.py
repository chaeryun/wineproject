...
urlpatterns = [
    ...
    path('latest_wine_list/<str:username>/', views.latest_wine_list), #최근에 내가 찜한 와인 리스트
    path('latest_wine_totallist/<str:username>/', views.latest_wine_totallist),

    path('recommand/latest_wishlist/<str:username>/', views.reco_wishlist), #찜 기반 와인 추천 
